...
-- 租户独立库建表脚本
-- 生成时间: 2026-04-28
-- 说明: 所有业务表迁移到租户独立库，不含 tenant_id 字段
--       租户隔离由数据源级别实现，无需行级 tenant_id 过滤
--       每个 CREATE TABLE 使用 IF NOT EXISTS，可安全重复执行
-- ============================================================

CREATE DATABASE IF NOT EXISTS tenant_000000 DEFAULT CHARSET utf8mb4 COLLATE utf8mb4_general_ci;
USE tenant_000000;

-- Table: ag_auto_version
CREATE TABLE IF NOT EXISTS `ag_auto_version` (
...
-- Table: ag_company_property
CREATE TABLE IF NOT EXISTS `ag_company_property` (
...
-- Table: ag_property_menu
CREATE TABLE IF NOT EXISTS `ag_property_menu` (
  `id` varchar(64) NOT NULL COMMENT '主键',
...
-- Table: ag_reader_param
CREATE TABLE IF NOT EXISTS `ag_reader_param` (
  `id` varchar(64) NOT NULL COMMENT '主键',
...
-- Table: ag_role
CREATE TABLE IF NOT EXISTS `ag_role` (
...
-- Table: ag_role_menu
CREATE TABLE IF NOT EXISTS `ag_role_menu` (
  `id` varchar(32) NOT NULL COMMENT '主键',
...
-- Table: ag_user_role
CREATE TABLE IF NOT EXISTS `ag_user_role` (
  `id` varchar(32) NOT NULL COMMENT '主键',
...
CREATE TABLE IF NOT EXISTS `ht_alert` (
  ...
  `building_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `unit_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `house_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `meter_id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `alert_status` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `org_id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `company_id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `create_dept` bigint DEFAULT NULL,
  `create_by` bigint DEFAULT NULL COMMENT '创建者',
  `create_time` datetime DEFAULT NULL,
  `in_maintenance` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `meter_id` (`meter_id`),
  KEY `idx_company_id` (`company_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='报警表';

-- Table: ht_house_strategy
CREATE TABLE IF NOT EXISTS `ht_house_strategy` (
  `id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `tasks_id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `type` tinyint NOT NULL,
  `strategy_id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `name` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `remark` varchar(125) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
-- Table: ht_instruction
CREATE TABLE IF NOT EXISTS `ht_instruction` (
  `id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `name` varchar(64) COLLATE utf8mb4_general_ci NOT NULL COMMENT '指令名称',
  `type` tinyint NOT NULL COMMENT '指令类型',
  `instruction` varchar(256) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '指令内容',
  `remark` varchar(60) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `create_dept` bigint DEFAULT NULL,
  `create_by` bigint DEFAULT NULL COMMENT '创建者',
  `create_time` datetime DEFAULT NULL,
  `update_by` bigint DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ht_repair` (
  ...
  `house_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `room_num` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `meter_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `meter_num` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `is_charged` tinyint DEFAULT '0',
  `valve_status` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `valve` tinyint DEFAULT NULL,
  `in_temp` decimal(6,2) DEFAULT NULL,
  `out_temp` decimal(6,2) DEFAULT NULL,
  `room_temp` decimal(6,2) DEFAULT NULL,
  ...
  `repair_info` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `repair_status` tinyint DEFAULT '0',
  `repair_result` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `org_id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `create_dept` bigint DEFAULT NULL,
  `create_by` bigint DEFAULT NULL COMMENT '创建者',
  `create_name` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
  `update_by` bigint DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  `in_maintenance` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `dispatch_id` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `dispatch_name` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `dispatch_time` datetime DEFAULT NULL,
  `repair_no` varchar(25) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fix_id` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fix_name` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ht_scope` (
  ...
  `company_id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `house_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `meter_num` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  `meter_id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `meter_arc_code` varchar(10) COLLATE utf8mb4_general_ci NOT NULL,
  `concentrator_code` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `imei` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `device_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `status` tinyint DEFAULT NULL,
  `is_special` tinyint(1) DEFAULT '0',
  `dtu_num` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `chan_num` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `create_dept` bigint DEFAULT NULL,
  `create_by` bigint DEFAULT NULL COMMENT '创建者',
  `create_time` datetime DEFAULT NULL,
  `update_by` bigint DEFAULT NULL,
...
-- Table: ht_scope_dtu
CREATE TABLE IF NOT EXISTS `ht_scope_dtu` (
  `id` varchar(64) NOT NULL COMMENT '主键',
  `tasks_id` varchar(64) DEFAULT NULL COMMENT '任务主表ID',
  `org_id` varchar(64) DEFAULT NULL COMMENT '小区ID',
  `company_id` varchar(64) DEFAULT NULL COMMENT '公司ID',
...
CREATE TABLE IF NOT EXISTS `ht_strategy` (
  `id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `name` varchar(64) COLLATE utf8mb4_general_ci NOT NULL COMMENT '策略名称',
  `type` tinyint DEFAULT NULL,
  `company_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ht_strategy_perform` (
  ...
  `instruction` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '指令内容',
  `name` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '指令名称',
...
-- Table: ht_strategy_sub
CREATE TABLE IF NOT EXISTS `ht_strategy_sub` (
  `id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `strategy_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `instruction_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `sort` int DEFAULT NULL,
  `valve_angle` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `create_dept` bigint DEFAULT NULL,
  `create_by` bigint DEFAULT NULL COMMENT '创建者',
  `create_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Table: ht_task_setting_log
CREATE TABLE IF NOT EXISTS `ht_task_setting_log` (
  `id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `task_id` varchar(5) COLLATE utf8mb4_general_ci NOT NULL,
  `scope_type` varchar(2) COLLATE utf8mb4_general_ci NOT NULL,
  `create_dept` bigint DEFAULT NULL,
  `create_by` bigint DEFAULT NULL COMMENT '创建者',
...
-- Table: ht_task_setting_log_item
CREATE TABLE IF NOT EXISTS `ht_task_setting_log_item` (
  `id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `main_id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `scope_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `meter_num` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ht_tasks` (
  ...
  `cu_group_id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `name` varchar(64) COLLATE utf8mb4_general_ci NOT NULL COMMENT '任务名称',
  `type` tinyint NOT NULL COMMENT '执行方式',
  `cron_expression` varchar(255) COLLATE utf8mb4_general_ci NOT NULL COMMENT '时间表达式',
  `strategy_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `priority` tinyint DEFAULT NULL,
  ...
  `bean_class` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `job_group` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `update_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='控制任务表';

-- Table: ht_tasks_perform
CREATE TABLE IF NOT EXISTS `ht_tasks_perform` (
  ...
  `org_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `company_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `concentrator_code` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `device_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `meter_num` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `meter_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `meter_arc_code` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `status` int DEFAULT NULL,
  `instruction_status` int DEFAULT NULL,
  `send_time` datetime DEFAULT NULL,
  `tasks_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `in_temp` decimal(6,2) DEFAULT NULL,
  `out_temp` decimal(6,2) DEFAULT NULL,
  `room_temp` decimal(6,2) DEFAULT NULL,
...
-- Table: ht_tasks_perform_last
CREATE TABLE IF NOT EXISTS `ht_tasks_perform_last` (
  `id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `tasks_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '控制任务ID',
  `instruction_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '指令ID',
  ...
  `unit` varchar(8) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '单位',
  `duration` tinyint(1) DEFAULT NULL COMMENT '作用时长',
  `org_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '小区ID',
  `company_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '公司ID',
  `concentrator_code` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '集中器编号',
  `tele_product_id` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '电信产品ID',
  `tele_api_key` varchar(256) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '电信平台Master-APIkey',
  `tele_app_key` varchar(256) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '电信平台AppKey',
  `device_id` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '设备ID',
  `meter_num` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '仪表号',
  `meter_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '仪表ID',
  `meter_arc_code` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '档案编号',
  ...
  `imei` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '设备IMEI',
  `dtu_num` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'DTU编号',
  `chan_num` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '通道号',
  ...
  `group_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '策略ID',
  `strategy_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '任务组ID',
...
CREATE TABLE IF NOT EXISTS `ht_tasks_perform_ls` (
  ...
  `unit` varchar(8) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '单位 01分钟 02小时 03天',
  `duration` tinyint(1) DEFAULT NULL COMMENT '作用时长',
  `org_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '小区ID',
  `company_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '公司ID',
  `concentrator_code` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '集中器编号',
  ...
  `alert_type` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '报警类型',
  `imei` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '设备IMEI号码',
  `dtu_num` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'DTU编号',
  `chan_num` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '通道号',
...
-- Table: mt_centrator_archive
CREATE TABLE IF NOT EXISTS `mt_centrator_archive` (
  `id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `sort_id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `code` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `name` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `specification` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `model` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `type` char(2) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `is_action` tinyint(1) DEFAULT NULL,
  `install_site` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `seq` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `update_by` bigint DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  `remark` varchar(80) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `name` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='集中器档案';

-- Table: mt_electric_archive
CREATE TABLE IF NOT EXISTS `mt_electric_archive` (
  ...
  `specification` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `model` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `rated_voltage` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `rated_current` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `voltage_ratio` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `current_ratio` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `load_limit` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `alarm_value` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `display_value` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `constant` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `is_enabled` int DEFAULT NULL,
  `seq` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
-- Table: mt_formula_file
CREATE TABLE IF NOT EXISTS `mt_formula_file` (
  `id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `name` varchar(512) COLLATE utf8mb4_general_ci NOT NULL COMMENT '公式名称',
  `type` varchar(32) COLLATE utf8mb4_general_ci NOT NULL COMMENT '公式类型',
  `cformula` varchar(512) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '中文公式',
  `eformula` varchar(512) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '英文公式',
  `seq` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '排序',
...
-- Table: mt_gas_archive
CREATE TABLE IF NOT EXISTS `mt_gas_archive` (
  `id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `sort_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `code` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `name` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `specification` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `model` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
-- Table: mt_meter_match
CREATE TABLE IF NOT EXISTS `mt_meter_match` (
  `id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `archive_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `company_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `meter_type` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `create_dept` bigint DEFAULT NULL,
  `create_by` bigint DEFAULT NULL COMMENT '创建者',
  `create_time` datetime DEFAULT NULL,
  `update_by` bigint DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `mt_meter_sort` (
  ...
  `name` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `model` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `vendor_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `is_onecard` tinyint DEFAULT '0',
  `measure_type` varchar(2) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `seq` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `meter_type` varchar(10) COLLATE utf8mb4_general_ci NOT NULL,
  `create_dept` bigint DEFAULT NULL,
  `create_by` bigint DEFAULT NULL COMMENT '创建者',
  `create_time` datetime DEFAULT NULL,
  `update_by` bigint DEFAULT NULL,
...
-- Table: mt_meter_vendor
CREATE TABLE IF NOT EXISTS `mt_meter_vendor` (
  `id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL COMMENT '主键',
  `code` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '厂商编码',
  `name` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '厂商名称',
  `contacts` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '厂商联系人',
  `tele` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '联系人电话',
  `address` varchar(125) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '厂商地址',
  `seq` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '排序',
  `is_enabled` int DEFAULT '1' COMMENT '是否启用',
  `create_dept` bigint DEFAULT NULL COMMENT '创建部门',
  `create_by` bigint DEFAULT NULL COMMENT '创建者',
  ...
  `remark` varchar(80) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `mt_water_archive` (
  ...
  `specification` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `model` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `constant` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `close_val` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `alarm_val` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `load_limit` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `seq` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `meter_num_required` tinyint(1) DEFAULT NULL,
...
-- Table: pm_parking_space
CREATE TABLE IF NOT EXISTS `pm_parking_space` (
  `id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `parking_code` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `parkinglot_name` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `standard_id` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
-- Table: pr_account_balance
CREATE TABLE IF NOT EXISTS `pr_account_balance` (
  `id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `user_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `house_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `item_group` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `item_code` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `pr_approval` (
  `id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `no` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '流程编号',
  `type` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '申请类型',
  `approval_user` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '申请人',
  `approval_time` datetime DEFAULT NULL COMMENT '申请时间',
  `title` varchar(256) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '任务名称',
  `preferential_type` int DEFAULT NULL COMMENT '减免类型',
  `preferential` decimal(10,2) DEFAULT NULL COMMENT '减免金额',
  `preferential_reason` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '减免原因',
  `approval_link` int DEFAULT NULL COMMENT '审批环节',
  `approval_type` int DEFAULT NULL COMMENT '审批类型',
  `company_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '公司ID',
  `org_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '小区ID',
  `approval_users` varchar(512) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '审批人(当前环节)',
  `approval_users_all` varchar(1024) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '所有审批人',
  `create_dept` bigint DEFAULT NULL,
  `create_by` bigint DEFAULT NULL COMMENT '创建者',
  `create_time` datetime DEFAULT NULL,
  `update_by` bigint DEFAULT NULL,
...
-- Table: pr_approval_opinion
CREATE TABLE IF NOT EXISTS `pr_approval_opinion` (
  `id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `approval_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '审批单ID',
  `approval_user` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '审批人',
  `approval_time` datetime DEFAULT NULL COMMENT '审批时间',
  `opinions` varchar(512) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '意见',
...
-- Table: pr_approval_sub
CREATE TABLE IF NOT EXISTS `pr_approval_sub` (
  `id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `approval_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '审批单ID',
  `expense_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '费用明细ID',
  `org_name` varchar(128) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `building_name` varchar(128) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `room_num` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `item_name` varchar(128) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `item_code` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `standard_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `warehouse_name` varchar(128) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `warehouse_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `material_name` varchar(128) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `material_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `material_user` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `material_use` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `company_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `org_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `create_dept` bigint DEFAULT NULL,
  `create_by` bigint DEFAULT NULL COMMENT '创建者',
...
-- Table: pr_billing_notes
CREATE TABLE IF NOT EXISTS `pr_billing_notes` (
  `id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `serial_num` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
...
-- Table: pr_building
CREATE TABLE IF NOT EXISTS `pr_building` (
  `id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL COMMENT '主键',
  `code` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '楼宇编码',
  `name` varchar(128) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '楼宇名称',
  ...
  `seq` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '排序',
  `used` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '用途',
  `delivery_time` datetime DEFAULT NULL COMMENT '交付时间',
  `station_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '热力站ID',
  `org_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '小区ID',
  `company_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '公司ID',
  `create_dept` bigint DEFAULT NULL COMMENT '创建部门',
  `create_by` bigint DEFAULT NULL COMMENT '创建者',
...
-- Table: pr_data_grant
CREATE TABLE IF NOT EXISTS `pr_data_grant` (
  `id` varchar(32) NOT NULL COMMENT '主键',
  `user_id` varchar(32) NOT NULL COMMENT '用户ID',
...
CREATE TABLE IF NOT EXISTS `pr_expense` (
  ...
  `price_formula` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `trade_times` int DEFAULT NULL,
  `max_money` decimal(18,4) DEFAULT NULL,
  `money_formula` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `record_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `delay_date` datetime DEFAULT NULL,
  `heat_usage` tinyint DEFAULT NULL,
  `is_calc` varchar(5) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `org_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `company_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `parking_space_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `create_dept` bigint DEFAULT NULL,
  `create_by` bigint DEFAULT NULL COMMENT '创建者',
  `create_time` datetime DEFAULT NULL,
  `update_by` bigint DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `pr_expense_item` (
  ...
  `precision_type` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
-- Table: pr_family
CREATE TABLE IF NOT EXISTS `pr_family` (
  `id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL COMMENT '主键',
  `user_id_no` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '客户证件号',
  `name` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '家庭成员姓名',
  `sex` int DEFAULT NULL COMMENT '性别',
  `contact_addr` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '联系地址',
  `employer` varchar(128) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '工作单位',
  `family_id_no` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '家庭成员证件号',
  `relation_type` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '与户主关系',
  `house_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '房屋ID',
  `create_dept` bigint DEFAULT NULL COMMENT '创建部门',
  `create_by` bigint DEFAULT NULL COMMENT '创建者',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_by` bigint DEFAULT NULL,
...
-- Table: pr_heat_archive
CREATE TABLE IF NOT EXISTS `pr_heat_archive` (
  `id` varchar(36) COLLATE utf8mb4_general_ci NOT NULL COMMENT '主键',
  `company_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '公司ID',
  `org_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '小区ID',
  `org_name` varchar(128) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '小区名称',
  `building_name` varchar(128) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '楼栋名称',
  `house_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '房屋ID',
  `room_num` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '房号',
  `archive_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '配表ID(关联)',
  `meter_arc_code` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '仪表档案编码',
  `meter_arc_name` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '仪表档案名称',
  `meter_num` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '表号',
  `imei` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'IMEI号',
  `card_num` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '卡号',
  `product_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '产品ID',
  `device_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '设备ID',
  `meter_serial` int DEFAULT NULL COMMENT '仪表序号',
  `line_number` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '线路号',
  `specification` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '规格',
  `model` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '型号',
  `concentrator_code` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '集中器编码',
  `install_site` varchar(128) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '安装位置',
  `standard_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '收费标准ID',
  ...
  `valve_status` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '阀门状态',
  ...
  `measurement` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '计量方式',
  `type` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '类型',
  `command` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '指令',
  `valve_opening` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '阀门开度',
  `command_time` datetime DEFAULT NULL COMMENT '指令下发时间',
  `return_time` datetime DEFAULT NULL COMMENT '指令返回时间',
  `command_status` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '指令状态',
  ...
  `del_flag` char(1) COLLATE utf8mb4_general_ci DEFAULT '0' COMMENT '删除标志(0存在 1删除)',
  `is_print` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '是否打印',
  `print_type` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '打印类型',
  `create_dept` bigint DEFAULT NULL COMMENT '创建部门',
  `create_by` bigint DEFAULT NULL COMMENT '创建者',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_by` bigint DEFAULT NULL,
...
-- Table: pr_heat_command_unit_valve_archive
CREATE TABLE IF NOT EXISTS `pr_heat_command_unit_valve_archive` (
  `id` varchar(36) COLLATE utf8mb4_general_ci NOT NULL COMMENT '主键',
  `archive_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '配表ID(关联)',
  `meter_num` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '表号',
  `card_num` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '卡号',
  ...
  `meter_arc_name` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '仪表档案名称',
  `concentrator_code` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '集中器编码',
  `imei_num` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'IMEI号',
  `product_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '产品ID',
  `device_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '设备ID',
  `meter_serial` int DEFAULT NULL COMMENT '仪表序号',
  `unit_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '单元ID',
  `org_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '小区ID',
  `company_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '公司ID',
  `valve_status` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '阀门状态',
  `setting_status` int DEFAULT NULL COMMENT '设定状态',
  ...
  `in_temperature` decimal(10,2) DEFAULT NULL COMMENT '进水温度',
  `out_temperature` decimal(10,2) DEFAULT NULL COMMENT '回水温度',
  `voltage` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '电压',
  ...
  `interval_unit` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '间隔单位',
  `valid_time` int DEFAULT NULL COMMENT '有效时间',
  `is_changed` int DEFAULT '0' COMMENT '是否换表 0否1是',
  `is_stop` int DEFAULT '0' COMMENT '是否停用 0否1是',
  `dtu_num` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'DTU号',
  `dtu_type` int DEFAULT NULL COMMENT 'DTU类型',
  `dtu_num_status` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'DTU号状态',
  `chan_num` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '通道号',
  `install_site` varchar(128) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '安装位置',
  `dtu_status` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'DTU状态',
  `caliber` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '口径',
  `create_dept` bigint DEFAULT NULL COMMENT '创建部门',
  `create_by` bigint DEFAULT NULL COMMENT '创建者',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_by` bigint DEFAULT NULL,
...
-- Table: pr_heat_command_valve_archive
CREATE TABLE IF NOT EXISTS `pr_heat_command_valve_archive` (
  `id` varchar(36) COLLATE utf8mb4_general_ci NOT NULL COMMENT '主键',
  `archive_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '配表ID(关联)',
  `meter_num` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '表号',
  `card_num` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '卡号',
...
-- Table: pr_heat_daily
CREATE TABLE IF NOT EXISTS `pr_heat_daily` (
...
-- Table: pr_heat_dtu_archive
CREATE TABLE IF NOT EXISTS `pr_heat_dtu_archive` (
  `id` varchar(36) COLLATE utf8mb4_general_ci NOT NULL COMMENT '主键',
  `dtu_num` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'DTU号',
  `install_site` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '安装位置',
...
-- Table: pr_heat_hot_archive
CREATE TABLE IF NOT EXISTS `pr_heat_hot_archive` (
  `id` varchar(36) COLLATE utf8mb4_general_ci NOT NULL COMMENT '主键',
  `archive_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '配表ID(关联)',
  `meter_arc_code` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '仪表档案编码',
  `meter_arc_name` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '仪表档案名称',
  ...
  `valve_time` datetime DEFAULT NULL COMMENT '阀门时间',
  `status1` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '状态1',
  `status2` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '状态2',
  ...
  `signal_strength` int DEFAULT NULL COMMENT '信号强度',
  `cell_status` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '电池状态',
  `is_opened` int DEFAULT '0' COMMENT '是否开户 0否1是',
  `opened_time` datetime DEFAULT NULL COMMENT '开户时间',
  `is_expense` int DEFAULT '0' COMMENT '是否产生费用 0否1是',
  `is_notify` int DEFAULT '0' COMMENT '是否通知 0否1是',
  ...
  `chan_num` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '通道号',
  `dtu_status` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'DTU状态',
  `install_type` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '安装方式',
  `create_dept` bigint DEFAULT NULL COMMENT '创建部门',
  `create_by` bigint DEFAULT NULL COMMENT '创建者',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_by` bigint DEFAULT NULL,
...
-- Table: pr_heat_month
CREATE TABLE IF NOT EXISTS `pr_heat_month` (
  `id` varchar(36) NOT NULL COMMENT '主键',
  `meter_num` varchar(36) DEFAULT NULL COMMENT '表号',
  `card_num` varchar(36) DEFAULT NULL COMMENT '卡号',
  `meter_id` varchar(36) DEFAULT NULL COMMENT '配表ID',
...
-- Table: pr_heat_reading
CREATE TABLE IF NOT EXISTS `pr_heat_reading` (
  `id` varchar(36) NOT NULL COMMENT '主键',
...
-- Table: pr_heat_real_data
CREATE TABLE IF NOT EXISTS `pr_heat_real_data` (
  `id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `house_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '房屋ID',
  `org_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '小区ID',
  `company_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '公司ID',
  `building_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '楼栋ID',
  `building_name` varchar(128) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '楼栋名称',
  `org_name` varchar(128) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '小区名称',
  `room_num` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '房间号',
  `unit_code` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '单元编号',
  `floor` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '楼层',
  `station_name` varchar(128) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '换热站名称',
  ...
  `attack_status` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '阀门设备状态',
  `meter_num` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '阀门编号',
  `rb_status1` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '热表状态1',
  `rb_status2` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '热表状态2',
  `rb_attack_status` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '热表设备状态',
  `rb_meter_num` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '热表编号',
  `rb_voltage` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '热表电量',
  `voltage` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '阀门电量',
  `rb_in` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '进水温度(热表)',
  ...
  `update_time` datetime DEFAULT NULL,
  `del_flag` char(1) COLLATE utf8mb4_general_ci DEFAULT '0',
  `rbin` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
-- Table: pr_heat_temp_archive
CREATE TABLE IF NOT EXISTS `pr_heat_temp_archive` (
  `id` varchar(36) COLLATE utf8mb4_general_ci NOT NULL COMMENT '主键',
  `archive_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '配表ID(关联)',
  `meter_arc_code` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '仪表档案编码',
  `meter_arc_name` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '仪表档案名称',
  ...
  `mov_place` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '移动位置',
...
-- Table: pr_heat_unit_hot_archive
CREATE TABLE IF NOT EXISTS `pr_heat_unit_hot_archive` (
  `id` varchar(36) COLLATE utf8mb4_general_ci NOT NULL COMMENT '主键',
  `archive_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '配表ID(关联)',
  `meter_arc_code` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '仪表档案编码',
  `meter_arc_name` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '仪表档案名称',
...
-- Table: pr_heat_unit_valve_archive
CREATE TABLE IF NOT EXISTS `pr_heat_unit_valve_archive` (
  `id` varchar(36) COLLATE utf8mb4_general_ci NOT NULL COMMENT '主键',
  `archive_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '配表ID(关联)',
  `meter_num` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '表号',
  `card_num` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '卡号',
...
-- Table: pr_heat_valve_archive
CREATE TABLE IF NOT EXISTS `pr_heat_valve_archive` (
  `id` varchar(36) COLLATE utf8mb4_general_ci NOT NULL COMMENT '主键',
  `archive_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '配表ID(关联)',
  `meter_num` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '表号',
  `card_num` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '卡号',
  ...
  `last_perform_id` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '最后执行ID',
  `dtu_num` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'DTU号',
  `dtu_num_status` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'DTU号状态',
  `chan_num` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '通道号',
  `install_site` varchar(128) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '安装位置',
  ...
  `caliber` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '口径',
  `install_type` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '安装方式',
  `group_num25` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '分组号25',
  `user_set_temp` decimal(10,2) DEFAULT NULL COMMENT '用户设定温度',
  `room_temp` decimal(10,2) DEFAULT NULL COMMENT '室温',
  `avg_temp` decimal(10,2) DEFAULT NULL COMMENT '平均温度',
  `valve_model` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '阀门型号',
...
CREATE TABLE IF NOT EXISTS `pr_house` (
  `id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `code` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '房屋编码',
  `room_num` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `building_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `building_name` varchar(128) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '楼宇名称',
  ...
  `nature` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '房屋性质',
  `structure` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '房屋结构',
  `type` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '房屋类型',
  `towards` varchar(16) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '朝向',
  `unit_type` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '单元类型',
  `unit_price` decimal(18,4) DEFAULT NULL COMMENT '单价',
  `property_term` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '产权年限',
  ...
  `address` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '邮寄地址',
  `decoration_status` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '装修状态',
  `status` varchar(16) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '房屋状态',
  `pay_status` tinyint DEFAULT NULL COMMENT '缴费状态:0-欠费,1-已缴,2-停供,3-空置',
  `is_special` tinyint unsigned DEFAULT '0' COMMENT '是否特殊户',
  `rental_status` varchar(16) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '出租状态',
  `seq` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '排序',
  `site_type` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '位置属性',
  `site_type_old` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '历史位置',
  `station_type` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '供热区域属性',
  ...
  `other_code` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '外部缴费编码',
  `area` decimal(18,4) DEFAULT NULL,
...
-- Table: pr_import_basic_data
CREATE TABLE IF NOT EXISTS `pr_import_basic_data` (
...
-- Table: pr_import_heat
CREATE TABLE IF NOT EXISTS `pr_import_heat` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '主键',
  `house_id` varchar(64) DEFAULT NULL COMMENT '房屋id',
  `archive_id` varchar(64) DEFAULT NULL COMMENT '仪表档案id',
  ...
  `standard_id` varchar(64) DEFAULT NULL COMMENT '单价id',
  ...
  `org_id` varchar(64) DEFAULT NULL COMMENT '小区id',
  `company_id` varchar(64) DEFAULT NULL COMMENT '所属物业公司id',
  `create_by` bigint DEFAULT NULL COMMENT '创建者',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
...
-- Table: pr_import_heat_temp
CREATE TABLE IF NOT EXISTS `pr_import_heat_temp` (
  `id` int NOT NULL AUTO_INCREMENT,
  `org_name` varchar(255) DEFAULT NULL,
  `building_name` varchar(255) DEFAULT NULL,
  `house_id` varchar(64) DEFAULT NULL,
...
-- Table: pr_import_history
CREATE TABLE IF NOT EXISTS `pr_import_history` (
  `id` int NOT NULL AUTO_INCREMENT,
  `org_name` varchar(255) DEFAULT NULL,
  `org_id` varchar(64) DEFAULT NULL,
  `building_name` varchar(255) DEFAULT NULL,
...
-- Table: pr_import_record
CREATE TABLE IF NOT EXISTS `pr_import_record` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `org_id` varchar(64) DEFAULT NULL,
  `company_id` varchar(64) DEFAULT NULL,
  `house_id` varchar(64) DEFAULT NULL,
...
-- Table: pr_import_unit_heat
CREATE TABLE IF NOT EXISTS `pr_import_unit_heat` (
  `id` int NOT NULL AUTO_INCREMENT,
  `building_id` varchar(64) DEFAULT NULL,
  `unit_id` varchar(64) DEFAULT NULL,
  `archive_id` varchar(64) DEFAULT NULL,
...
-- Table: pr_import_unit_valve
CREATE TABLE IF NOT EXISTS `pr_import_unit_valve` (
  `id` int NOT NULL AUTO_INCREMENT,
  `building_id` varchar(64) DEFAULT NULL,
  `unit_id` varchar(64) DEFAULT NULL,
  `archive_id` varchar(64) DEFAULT NULL,
...
-- Table: pr_import_valve
CREATE TABLE IF NOT EXISTS `pr_import_valve` (
  `id` int NOT NULL AUTO_INCREMENT,
  `house_id` varchar(64) DEFAULT NULL,
  `archive_id` varchar(64) DEFAULT NULL,
  `meter_serial` int DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `pr_options` (
  ...
  `org_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `company_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `option_key` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `option_value` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `option_type` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `create_dept` bigint DEFAULT NULL,
  `create_by` bigint DEFAULT NULL COMMENT '创建者',
  `create_time` datetime DEFAULT NULL,
  `update_by` bigint DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `pr_options_heat` (
  ...
  `quittance_title` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `start_serial` bigint DEFAULT NULL,
  `serial_length` int DEFAULT NULL,
  `letter_prefix` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `serial_prefix` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `round_mode` int DEFAULT NULL,
  `define1` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `define2` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `tele_api_key` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `tele_app_key` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `tele_app_secret` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `tele_product_id` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `house_small_color` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `house_medium_color` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `house_big_color` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `back_water_min` decimal(12,4) DEFAULT NULL,
  `back_water_max` decimal(12,4) DEFAULT NULL,
  `back_water_small_color` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `back_water_medium_color` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `back_water_big_color` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `floor_view_complete_color` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `floor_view_no_complete_color` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `floor_view_abnormal_color` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `heat_start_date` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `heat_end_date` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `charge_standard_type` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `penalty_rate` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `invoice_notes` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `payment_reminder` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `pr_print_template` (
  ...
  `del_flag` char(1) COLLATE utf8mb4_general_ci DEFAULT '0',
  `remark` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `serial_num` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_company_org` (`company_id`,`org_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='打印模板';

-- Table: pr_reconciliation_diff
...
CREATE TABLE IF NOT EXISTS `pr_standard` (
  ...
  `generate_rule` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `step_type` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `statistics_type` varchar(5) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `step_maxgrade` int DEFAULT NULL,
  `is_step2` tinyint DEFAULT NULL,
  `step2_type` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `step2_maxgrade` int DEFAULT NULL,
  `is_latefee` tinyint DEFAULT NULL,
  `latefee_startdate` datetime DEFAULT NULL,
  `latefee_type` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `latefee_startdays` int DEFAULT NULL,
  `latefee_formula` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `is_limited` tinyint DEFAULT NULL,
  `limited_type` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `limited_cond` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `del_flag` char(1) COLLATE utf8mb4_general_ci DEFAULT '0',
  `remark` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `step2type` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `pr_standard_price` (
  ...
  `end_time` datetime DEFAULT NULL,
  `line_mode` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
-- Table: pr_transaction_record
CREATE TABLE IF NOT EXISTS `pr_transaction_record` (
  `id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `serial_num` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `operator_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `notes` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `original_record_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `invoice_no` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `create_dept` bigint DEFAULT NULL,
  `create_by` bigint DEFAULT NULL COMMENT '创建者',
  `create_time` datetime DEFAULT NULL,
  `update_by` bigint DEFAULT NULL,
...
-- Table: pr_transaction_record_sub
CREATE TABLE IF NOT EXISTS `pr_transaction_record_sub` (
  `id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `main_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `expense_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `amount` decimal(18,4) DEFAULT '0.0000',
  `balance_before` decimal(18,4) DEFAULT '0.0000',
  `balance_after` decimal(18,4) DEFAULT '0.0000',
  `item_name` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `notes` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `item_group` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '费项分组',
  `item_code` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '费项编码',
  `house_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '房屋ID',
  `create_dept` bigint DEFAULT NULL,
  `create_by` bigint DEFAULT NULL COMMENT '创建者',
  `create_time` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `pr_unit` (
  `id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL COMMENT '主键',
  `code` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '单元编码',
  `name` varchar(128) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '单元名称',
  `building_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '楼宇ID',
  `on_floor` int DEFAULT NULL COMMENT '地上楼层',
  `heating_area` decimal(18,4) DEFAULT NULL COMMENT '供热面积',
  `up_floor` int DEFAULT NULL COMMENT '地下楼层',
  `floor` int DEFAULT NULL COMMENT '总楼层',
  `site` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '位置',
  `seq` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '排序',
  `station_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '热力站ID',
  `org_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '小区ID',
  `company_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '公司ID',
...
-- Table: pr_use_card_log
CREATE TABLE IF NOT EXISTS `pr_use_card_log` (
  `id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `meter_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `meter_num` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `user_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `card_num` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `pr_user` (
  ...
  `user_name` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `phone` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `id_no` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `id_startdate` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `id_enddate` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `id_department` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `employer` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `open_id` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `wx_number` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `qq_number` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `occupation` int DEFAULT NULL,
  `education` int DEFAULT NULL,
  `hobby` int DEFAULT NULL,
  `email` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `emer_contact` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `emer_phone` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `seq` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `password` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `head_photo` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `front_photo` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `back_photo` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_phone` (`phone`),
  KEY `idx_company_org` (`company_id`,`org_id`)
...
CREATE TABLE IF NOT EXISTS `pr_user_house` (
  ...
  `user_name` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '用户名',
  `phone` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '手机号',
  `house_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '房屋ID',
  `relation_type` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '关系类型',
  `company_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '公司ID',
  `create_dept` bigint DEFAULT NULL COMMENT '创建部门',
  `create_by` bigint DEFAULT NULL COMMENT '创建者',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  ...
  `remark` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '备注',
  `org_id` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '小区ID',
  `record_source` varchar(5) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '记录来源',
  PRIMARY KEY (`id`),
  KEY `idx_user_id` (`user_id`),
  KEY `idx_house_id` (`house_id`),
  KEY `idx_company_id` (`company_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='用户-房屋关联表';

-- Table: pr_wechat_bill
...
CREATE TABLE IF NOT EXISTS `sys_area` (
  ...
  `parent_id` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '1' COMMENT '父级ID',
  `parent_ids` varchar(2000) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '所有父级ID',
  `name` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '名称',
  `sort` int DEFAULT NULL COMMENT '排序',
  `code` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '区划代码',
  `code2` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '备用代码',
  `type` varchar(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '类型：1=省，2=市，3=区县',
  `create_by` bigint DEFAULT NULL COMMENT '创建者',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
