...
/**
 * 供热系统选项业务对象
 * 字段须与实体 PrOptionsHeat 保持一致——前端 8 个 Tab（供热周期/阀门控制/调控参数/
 * 报警参数/温度显示/保温参数/收据设置/NB模组）的字段均经此 Bo 接收并 convert 落库，
 * 缺字段会导致对应 Tab 的配置在 MapstructUtils.convert 时被静默丢弃（“假保存”）。
 */
@Data
