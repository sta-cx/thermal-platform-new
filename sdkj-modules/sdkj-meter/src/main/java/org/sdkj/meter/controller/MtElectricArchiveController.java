...
import org.sdkj.meter.domain.bo.MtElectricArchiveBo;
...
public class MtElectricArchiveController extends BaseController {
     ...
     */
    @SaCheckPermission("thermal:meter:electric:add")
    @SaCheckLogin
    @Log(title = "电表档案", businessType = BusinessType.INSERT)
    @PostMapping
    public R<Void> add(@Validated @RequestBody MtElectricArchiveBo bo) {
        MtElectricArchive archive = MapstructUtils.convert(bo, MtElectricArchive.class);
     ...
     */
    @SaCheckPermission("thermal:meter:electric:edit")
    @SaCheckLogin
    @Log(title = "电表档案", businessType = BusinessType.UPDATE)
    @PutMapping
    public R<Void> edit(@Validated @RequestBody MtElectricArchiveBo bo) {
        MtElectricArchive archive = MapstructUtils.convert(bo, MtElectricArchive.class);
     ...
     */
    @SaCheckPermission("thermal:meter:electric:remove")
    @SaCheckLogin
