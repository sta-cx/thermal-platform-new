...
/**
 * 燃气表档案 Mapper
 * 迁移自旧系统 MtGasArchiveMapper
 */
public interface MtGasArchiveMapper extends BaseMapperPlus<MtGasArchive, MtGasArchiveVo> {
     ...
     * @return 插入数量
     */
    int insertMeterToAgent(@Param("entity") MtGasArchive entity);
