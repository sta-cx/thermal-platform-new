...
import org.sdkj.common.core.utils.TreeBuildUtils;
...
import org.sdkj.system.domain.vo.RouterVo;
...
public class SysMenuServiceImpl implements ISysMenuService {
    ...
    public List<RouterVo> buildMenus(List<SysMenu> menus) {
        ...
        for (SysMenu menu : menus) {
            ...
            router.setHidden(SystemConstants.DISABLE.equals(menu.getVisible()));
            router.setName(name);
            router.setPath(menu.getRouterPath());
            router.setComponent(menu.getComponentInfo());
            router.setQuery(menu.getQueryParam());
            router.setMeta(new MetaVo(menu.getMenuName(), menu.getIcon(), StringUtils.equals(SystemConstants.DISABLE, menu.getIsCache()), menu.getPath(), menu.getRemark()));
            ...
            if (CollUtil.isNotEmpty(cMenus) && SystemConstants.TYPE_DIR.equals(menu.getMenuType())) {
                ...
                children.setMeta(new MetaVo(menu.getMenuName(), menu.getIcon(), StringUtils.equals(SystemConstants.DISABLE, menu.getIsCache()), menu.getPath(), menu.getRemark()));
