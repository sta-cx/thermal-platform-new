package org.sdkj.common.security.config;
...
import org.sdkj.common.security.config.properties.SecurityProperties;
import org.sdkj.common.security.handler.AllUrlHandler;
        ...
        registry.addInterceptor(new SaInterceptor(handler -> {
                ...
                SaRouter
                    ...
                    .check(() -> {
                        ...
                        // 部署后旧 token（无 clientId extra）会被拒绝，用户需重新登录
                        ...
                        String clientId = extraObj.toString();
